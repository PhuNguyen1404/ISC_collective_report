          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            <Card className="border-orange-200 hover:shadow-lg transition-shadow">
              <CardHeader className="text-center">
                ...
                <CardDescription>Customer Voice Telecom</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card className="border-blue-200 hover:shadow-lg transition-shadow">
              <CardHeader className="text-center">
                ...
                <CardDescription>Multi-channel Agent Tool</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="flex flex-wrap gap-2 justify-center">
                  <Badge variant="secondary">PHP</Badge>
            ...
            <Card className="border-green-200 hover:shadow-lg transition-shadow">
              <CardHeader className="text-center">
                ...
                <CardDescription>Upcoming Project</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="flex flex-wrap gap-2 justify-center">
            ...
            <Link href="/lessons">
              <Card className="hover:shadow-lg transition-all duration-300 hover:scale-105 cursor-pointer">
                <CardContent className="p-6 text-center">
                  ...
                  <h3 className="font-semibold text-gray-900 mb-2">Bài Học</h3>
                  <p className="text-sm text-gray-600">
            ...
            <Link href="/future">
              <Card className="hover:shadow-lg transition-all duration-300 hover:scale-105 cursor-pointer">
                <CardContent className="p-6 text-center">
                  ...
                  <h3 className="font-semibold text-gray-900 mb-2">Kế Hoạch</h3>
                  <p className="text-sm text-gray-600">Định hướng tương lai</p>
                </CardContent>
              </Card>
            </Link>
          </div>
